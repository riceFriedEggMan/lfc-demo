...
import com.rice.lfcdemo.service.rabbitMq.MessageConsumer;
import com.rice.lfcdemo.service.rabbitMq.MessageProducer;
...
public class TriggerPoolTask {
    ...
    public void run(TaskModel taskModel) {
        ...
        // 执行器执行
        messageProducer.sendMessage(TimerUtils.UnionTimerIDUnix(taskModel.getTimerId(), taskModel.getRunTimer()));
